...
RIN=monitoring_scripts/gasbed_router_dummy_noPA.xml
ROUT=monitoring_scripts/gasbed_routeroptions.xml
CONTROL_SCRIPT=monitoring_scripts/gasbed_control_noPA.xml
AWK=gawk
