 ...
 */
public static Datagram newDatagram(int protocol,
    ByteBuffer payload)                      {
 ...
 */
public static Constructor<? extends Datagram>getByteBufferConstructor(
    int protocol)
{
    // get DatagramFactoryInfo for protocol
 ...
 */
public static void setClassForProtocol(String className,
    int protocol)                   {
