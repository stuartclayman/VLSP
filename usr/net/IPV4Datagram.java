...
public class IPV4Datagram implements Datagram, DatagramPatch {
     ...
     */
    public IPV4Datagram(ByteBuffer payload) {
        payload.rewind();
     ...
     */
    public IPV4Datagram(ByteBuffer payload, Address address) {
        payload.rewind();
        dstAddr = address;
     ...
     */
    public IPV4Datagram(ByteBuffer payload, Address address, int port) {
        payload.rewind();
        dstAddr = address;
        dstPort = port;
