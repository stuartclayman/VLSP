...
public class OnRouterEvent extends AbstractEvent {
    int routerNo_ = 0;
    ...
    public OnRouterEvent(long time, EventEngine eng, int rNo, String cname, String []   args) {
        time_ = time;
        engine_ = eng;
        routerNo_ = rNo;
        className_ = cname;
    ...
    public OnRouterEvent(long time, EventEngine eng, String addr, String cname, String []   args) {
        time_ = time;
        engine_ = eng;
        className_ = cname;
        address_ = addr;
    ...
    public OnRouterEvent(long time, EventEngine eng, String addr, String cname, String []        args, GlobalController gc)
