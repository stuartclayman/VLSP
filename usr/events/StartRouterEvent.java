...
public static int startRouter(GlobalController gc, long time,
...
private static boolean doRouterStart(GlobalController gc, int id, 
    String address, String name)                       {
...
private static boolean tryRouterStart(GlobalController gc, int id, String address, 
    String name, LocalControllerInfo local, LocalControllerInteractor lci)
throws IOException 
{
    int port = 0;
    ...
    try {
        ...
        BasicRouterInfo br = new BasicRouterInfo
                    ...
                    "routerID"), gc.getElapsedTime(), local,
