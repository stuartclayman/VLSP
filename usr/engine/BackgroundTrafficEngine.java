...
EventEngineException {
    ...
    if (trafficArriveDist_ == null) throw new EventEngineException(
            "Background traffic engine must specify arrival distribution.");
    if (trafficLengthDist_ == null) throw new EventEngineException(
            "Background traffic engine must specify length distribution.");
    if (trafficSpeedDist_ == null) throw new EventEngineException(
...
private void startNewConnection(long currTime,
    EventScheduler s,
    GlobalController g)
{
    double scale = 1.0;
...
private void parseXMLFile(String fName) throws EventEngineException {
    try {
        ...
        if (basenode == null) throw new SAXException(
                "Document requires basenode");
        if (!basenode.equals("BackgroundTrafficEngine")) throw new
                  SAXException(
        ...
        trafficArriveDist_ = ProbDistribution.parseProbDist(
            n, "TrafficArriveDist");
        if (trafficArriveDist_ == null) throw new SAXException(
        ...
        trafficLengthDist_ = ProbDistribution.parseProbDist(
            n, "TrafficLengthDist");
        if (trafficLengthDist_ == null) throw new SAXException(
        ...
        trafficSpeedDist_ = ProbDistribution.parseProbDist(
            n, "TrafficSpeedDist");
        if (trafficSpeedDist_ == null) throw new SAXException(
