 ...
 */
public abstract class RouterProbe extends AbstractProbe implements
Probe
{
...
public void lastMeasurement(){
    //System.out.println("NetIFStatsProbe: last collect for " +
    // controller.getName());
    try {
        Measurement m = collectThenCheck();
        getProbeManager().notifyMeasurement(m);
    } catch (Exception e) {
        //System.err.println("NetIFStatsProbe: last collect failed -
        // " +
        // e);
    }
}
