 ...
 */
public void createLink(Request request,
...
JSONException {
    ...
    int linkID = gc.startLink(
        System.currentTimeMillis(), router1, router2, weight,
        linkName);
 ...
 */
public void deleteLink(Request request,
    Response response) throws IOException,
JSONException {
    ...
    if (sc.hasNextInt()) {
        ...
        if (gc.isValidLinkID(id)) {
            ...
            gc.endLink(
                ...
                (Integer)li.getEndPoints().getFirst(),
            ...
            badRequest(response,
                "deleteLink arg is not valid router id: " +
                name);
        }
    } else {
        badRequest(response,
 ...
 */
public void listLinks(Request request,
    Response response) throws IOException,
JSONException {
    // and send them back as the return value
    PrintStream out = response.getPrintStream();
 ...
 */
public void getLinkInfo(Request request,
    Response response) throws IOException,
JSONException {
