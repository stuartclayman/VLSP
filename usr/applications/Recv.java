...
public class Recv implements Application {
    ...
    public ApplicationResponse stop() {
        ...
        if (socket != null) {
            ...
            Logger.getLogger("log").logln(USR.ERROR, "Recv stop");
        }
    ...
    public void run()  {
        ...
        while ((datagram = socket.receive()) != null) {
            ...
            Logger.getLogger("log").log(USR.ERROR, count + ". ");
            Logger.getLogger("log").log(USR.ERROR, "HL: " + datagram.getHeaderLength() +
            ...
            if (payload == null) {
                Logger.getLogger("log").log(USR.ERROR, "No payload");
            } else {
                Logger.getLogger("log").log(USR.ERROR, new String(payload));
            }
            Logger.getLogger("log").log(USR.ERROR, "\n");
