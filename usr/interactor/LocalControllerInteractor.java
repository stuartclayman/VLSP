 ...
 * Name is optional.
 */
public JSONObject newRouter(int routerId,
    int port1,
    int port2,
    String address,
    String name)
 ...
 * Name is optional.
 */
public String connectRouters(String host1,
    int port1,
    String host2,
    int port2,
    int weight,
...
public Boolean endLink(String host1, int port1,
 ...
 */
public JSONObject appStart(int routerId, String className,
 ...
 */
public Boolean checkLocalController(String host,
...
public Boolean setAP(int GID,
    int APGID) throws IOException, JSONException {
    String toSend;
...
public Boolean reportAP(int GID,
    int AP) throws IOException, JSONException {
 ...
 */
public Boolean monitoringStart(InetSocketAddress addr,
    int howOften) throws
IOException,
JSONException {
