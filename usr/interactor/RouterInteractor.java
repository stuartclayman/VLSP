 ...
 */
public RouterInteractor(String addr,
 ...
 * @param port the port the server is listening on
 */
public RouterInteractor(InetAddress addr,
    int port) throws UnknownHostException,
IOException {
 ...
 */
public RouterInteractor setPortAddress(String port,
    String type,
    String addr) throws
IOException,
JSONException {
 ...
 */
public RouterInteractor incomingConnection(String connectionID,
    String name,
    Address addr,
    int weight,
    int port) throws
 ...
 */
public JSONObject appStart(String className,
 ...
 */
public String createConnection(String address, int weight,
 ...
 */
public RouterInteractor monitoringStart(InetSocketAddress addr,
    int howOften)
throws
IOException, JSONException {
