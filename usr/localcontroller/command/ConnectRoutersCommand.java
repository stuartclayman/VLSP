...
public boolean evaluate(Request request,
    ...
    try {
        ...
        if (args.length != 4 && args.length != 5) {
            ...
            jsobj.put(
                "error",
                "Expected four or five arguments for Connect Routers Command");
        ...
        try {
            ...
            JSONObject jsobj = new JSONObject();
            jsobj.put("error",
                "BAD weight for link: " + nfe.getMessage());
            ...
            jsobj.put(
                "error",
                "CANNOT DECODE HOST INFO FOR CONNECT ROUTER COMMAND"
                +
                e.getMessage());
        ...
        String connectionName =
            controller.connectRouters(r1, r2, weight,
                name);
