 ...
 */
class Intercept4 extends RestyTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            JSONObject ad1 = test.createApp(router2, "demo_usr.nfv.NetPrint", "-i 2 -m 10000 -v");
            ...
            JSONObject a2 = test.createApp(router1, "usr.applications.Send", router3 + " 4000 100 -i 5 -b 20");  // id 4000 count
            System.out.println("a2 = " + a2);

            /* sleep 15 seconds */
            Thread.sleep(15000);

            // send msg to router 2 port 10000
            JSONObject ad2 = test.createApp(router2, "demo_usr.paths.AdaptIngress", "2:10000 123:4567");
