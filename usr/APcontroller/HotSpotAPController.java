...
/** Implements HotSpotAP Controller -- default actions are from
 * NullAPController*/
...
/** Use the controller to remove the least efficient AP using HotSpot
 * alg*/
...
int getHotSpotScore(int gid,
    ...
    while (toVisitCtr > 0) {
        ...
        if (visitCost[node] == hotSpotMax) {            //  Only count
                                                        // nodes
                                                        // within number
                                                        // of hops
            continue;
