 ...
 */
public class CommandAsRestHandler extends AbstractRequestHandler implements RequestHandler {
    ...
    public void  handle(Request request, Response response) {
        try {
            ...
            RestCommand command = (RestCommand)getManagementConsole().find(commandName);
            boolean result;
            ...
            if (command != null) {
                ...
                command = (RestCommand)getManagementConsole().find("__UNKNOWN__");
            }
