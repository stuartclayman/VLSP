 ...
 */
public abstract class AbstractRestConsole implements Container,
                      ManagementConsole
{
...
public boolean start(){
    ...
    if (unknown == null) {
        Logger.getLogger("log").logln(USR.ERROR,
            leadin() +
            "the UnknownCommand has not been registered");
        return false;
    }
...
public void handle(Request request,
    ...
    try {
        ...
        for (String pattern : patterns) {
            if (directory.equals(pattern) ||
                path.matches(pattern)) {
                RequestHandler handler =
                    (RequestHandler)handlerMap.get(
                        pattern);
        ...
        {
            System.out.println(
                "AbstractRestConsole error: " + "no command");
 ...
 */
public void defineRequestHandler(String pattern,
    RequestHandler rh)                       {
