...
AbstractRequestHandler implements RequestHandler {
     ...
     */
    protected AbstractRestRequestHandler badRequest(Response response, String msg) throws
     ...
     */
    protected AbstractRestRequestHandler complain(Response response, String msg) throws
    IOException, JSONException {
        PrintStream out = response.getPrintStream();
     ...
     */
    protected AbstractRestRequestHandler notFound(Response response, String msg) throws
    IOException, JSONException {
        PrintStream out = response.getPrintStream();
