...
import demo_usr.energy.viewer.*;

public class MonViewer extends EnergyViewer {
    // Controller host
    String host;
     ...
     */
    public MonViewer(String host, int port) {
        this.host = host;
        this.port = port;
    ...
    protected boolean connect() {
        ...
        if (showEnergyPrices) {
            System.out.print("MonViewer: starting MonViewerConsole on port " + consolePort);
    ...
    protected void collectData() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.print("MonViewer: No VIM.  Waiting......");
                ...
                System.out.print(ANSI.POS(0,0));
                System.out.print(ANSI.CLEAR_EOS);
                //System.out.print("MonViewer: No VIM. " + me.getMessage() + " Waiting......");
    ...
    protected void presentData(JSONObject localhostInfo, JSONObject routerThreadGroups) {
        ...
        try {
            ...
            if (hostDetail.length() == 0) {
                System.out.print(ANSI.CLEAR_EOS);
                System.out.print("Waiting for Adaptor ......");
                return;
            }
            ...
            double energyPerCent = (energyDeltaThisTime * 100) / (energyTotalThisTime == 0.0 ? 1 : energyTotalThisTime);  // WAS / energyUsage;
            ...
            if (showEnergyPrices) {
                ...
                System.out.printf("%-16s%-12s%-12s%-12s%-12s%-12s%-12.3f%-10.3f", "", "","","","","", energyTotalThisTime, energyDeltaThisTime);
            }
    ...
    protected void setEnergyPrice(Double price) {
        System.err.println("MonViewer price set to: " + price);
        energyPrice = price;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int arg=0; arg < argc; arg++) {
            ...
            if (thisArg.charAt(0) == '-') {
                ...
                default:
                    System.err.println("MonViewer: unknown option " + option);
                    break;
        ...
        try {
            // start a MonViewer
            viewer = new MonViewer(gcHost, gcPort);
            // set the timeout
            ...
            System.err.println("MonViewer Exception: " + e);
            e.printStackTrace();
            System.exit(1);
        }
    }
    ...
    private static void help() {
        System.err.println("MonViewer [-t timeout] [-g gc_host]  [-p gc_port] [-c console_port] [-e] [-l]");
        System.exit(1);
    }
