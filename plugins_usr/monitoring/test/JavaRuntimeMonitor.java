...
public static void main(String [] args){
    ...
    // we got a hostname
    JavaRuntimeMonitor hostMon = new JavaRuntimeMonitor(addr,
        appPort);

    //Probe javaProbe = new JavaMemoryProbe("localhost" +
    // ".javaMemory");
    Probe javaProbe = new InfraProbe("uk.ac.ucl.ee.Service1",
        "localhost");
