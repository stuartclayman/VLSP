...
public void start(){
    ...
    if (actualAggregateFn == null) throw new Error(
    ...
    // set up data plane
    DataPlane outputDataPlane = new USRDataPlaneProducerWithNames(
        outputDataAddress);
        ...
        if (thisArg.charAt(0) == '-') {
            ...
            case 'a': {
                if (argValue.equals("average")) {
                    aggPoint.setAggregateFn(
                        AggregateFnSpecifer.Average);
                } else if (argValue.equals("variance")) {
                    aggPoint.setAggregateFn(
                        AggregateFnSpecifer.Variance);
